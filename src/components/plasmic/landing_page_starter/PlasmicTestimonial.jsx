...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: f8sA8K8KmUFdPE/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__fjwTz)}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___2LqF)}
      >
        <p.PlasmicImg
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__hAaeZ)}
        >
          <div className={classNames(projectcss.all, sty.freeBox__mHe3W)}>
            {p.renderPlasmicSlot({
