...
import sty from "./PlasmicButton.module.css"; // plasmic-import: figTdjOb9OIT5I/css
import AppleIcon from "./icons/PlasmicIcon__Apple"; // plasmic-import: _XB5P6HH6751yP/icon
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <AppleIcon
                className={classNames(projectcss.all, sty.svg__pkJg8)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <AppleIcon
                className={classNames(projectcss.all, sty.svg__iiY70)}
                role={"img"}
              />
            ),
