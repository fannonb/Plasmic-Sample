...
import sty from "./PlasmicListItem.module.css"; // plasmic-import: uE23GPZCno6HQz/css
    ...
    () => [
      {
        ...
        initFunc: true
          ? ({ $props, $state, $queries, $ctx }) => $props.bottomBorder
          : undefined
      },
      {
        path: "leftCheck",
        ...
        variableType: "variant",
        initFunc: true
          ? ({ $props, $state, $queries, $ctx }) => $props.leftCheck
          : undefined
      }
    ],
  ...
  return (
    ...
    >
      ...
      {p.renderPlasmicSlot({
        defaultContents: (
          <CheckCircleIcon
            className={classNames(projectcss.all, sty.svg__o6YPz)}
            role={"img"}
          />
        ),
