...
import sty from "./PlasmicValueProp.module.css"; // plasmic-import: 17XITOzK4mT8JI/css
    ...
    () => [
      {
        ...
        initFunc: true
          ? ({ $props, $state, $queries, $ctx }) => $props.flatIcon
          : undefined
      },
      {
        path: "vertical",
        ...
        variableType: "variant",
        initFunc: true
          ? ({ $props, $state, $queries, $ctx }) => $props.vertical
          : undefined
      },
      {
        path: "card",
        ...
        variableType: "variant",
        initFunc: true
          ? ({ $props, $state, $queries, $ctx }) => $props.card
          : undefined
      },
      {
        path: "noTitle",
      ...
      },
      {
        ...
        variableType: "variant",
        initFunc: true
          ? ({ $props, $state, $queries, $ctx }) => $props.darkBackground
          : undefined
      }
    ],
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <p.PlasmicImg
              alt={""}
              className={classNames(sty.img__gyPY)}
              displayHeight={"56px"}
